<template>
<div>
  <basic-card v-bind:lnk="'https://github.com/alexarlord-boop/python_au/tree/main/requests'" class="sideproject"
             :card-number="'card2'">
    <template v-slot:image>
      <svg xmlns="http://www.w3.org/2000/svg" width="5rem" height="5rem" class="bi bi-tools m-3"
           viewBox="0 0 16 16">
        <path
