<template>
<div>
  <basic-card v-bind:lnk="'https://github.com/alexarlord-boop/union-station'" class="sideproject">
    ...
    <template v-slot:small-icon>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="bi bi-github"
           viewBox="0 0 16 16">
        <path
